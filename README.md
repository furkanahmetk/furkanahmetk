# Hi there, I'm Furkan Ahmet Kara 👋

A Software Developer focused on Python engineering, Artificial Intelligence (AI), and Blockchain infrastructures. I enjoy building scalable backend architectures, working with computer vision workflows, and contributing to global open-source ecosystems.

### 💼 Current Focus
- **Software Development Specialist** at Varan Teknoloji ve Lojistik (Working on AI-integrated applications, blockchain systems, and open-source practices).
- **Core Developer & Translator** at LibreOffice (The Document Foundation) & GNOME contributor.
- **Blockchain Node Operator** on the Casper Network.
